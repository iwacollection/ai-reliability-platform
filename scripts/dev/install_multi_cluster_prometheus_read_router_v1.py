...
VERSION = "multi-cluster-prometheus-read-router-v1"

AFTER_NAME = (
    "multi_cluster_prometheus_read_router_v1_after.txt"
)

ERROR_NAME = (
    "multi_cluster_prometheus_read_router_v1_error.txt"
)
...
def main() -> int:
    ...
    report = [
        "Multi-Cluster Prometheus Read Router v1",
    ...
    try:
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Multi-Cluster Prometheus Read Router v1 is installed.",
                "",
        ...
        print(
            "MULTI-CLUSTER PROMETHEUS READ ROUTER V1 PASSED"
        )
        print(
            "=" * 72
        )
        ...
        write_text(
            ...
            "\n".join(
                [
                    "Multi-Cluster Prometheus Read Router v1 FAILED",
                    (
                        "GeneratedAt: "
