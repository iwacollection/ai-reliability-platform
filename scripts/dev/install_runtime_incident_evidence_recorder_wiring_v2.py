...
VERSION = "runtime-incident-evidence-recorder-wiring-v2"
AFTER_NAME = "runtime_incident_evidence_recorder_wiring_v2_after.txt"
ERROR_NAME = "runtime_incident_evidence_recorder_wiring_v2_error.txt"
...
def main() -> int:
    ...
    report = [
        "Runtime Incident Evidence Recorder Wiring v2",
        ...
        "- v2 test fixture uses the repository-native ToolManager/ToolRegistry",
    ]
    ...
    try:
        ...
        error_lines = [
            "Runtime Incident Evidence Recorder Wiring v2 FAILED",
            f"GeneratedAt: {datetime.now().astimezone().isoformat()}",
            "",
            "Exception:",
