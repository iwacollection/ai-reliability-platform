...
VERSION = "production-incident-evidence-recorder-v2"
AFTER_NAME = "production_incident_evidence_recorder_v2_after.txt"
ERROR_NAME = "production_incident_evidence_recorder_v2_error.txt"
...
def main() -> int:
    ...
    report = [
        "Production Incident Evidence Recorder v2",
        ...
        "- v2 fixes replay test context by providing trace=None",
    ]
    ...
    try:
        ...
        error_lines = [
            "Production Incident Evidence Recorder v2 FAILED",
            f"GeneratedAt: {datetime.now().astimezone().isoformat()}",
            "",
            "Exception:",
