...
VERSION = "multi-cluster-connection-config-registry-factory-v1"

AFTER_NAME = (
    "multi_cluster_connection_config_registry_factory_v1_after.txt"
)

ERROR_NAME = (
    "multi_cluster_connection_config_registry_factory_v1_error.txt"
)
...
def main() -> int:
    ...
    report = [
        "Multi-Cluster Connection Config / Registry Factory v1",
    ...
    try:
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Multi-Cluster Connection Config / Registry Factory v1 is installed.",
                "",
        ...
        print(
            "MULTI-CLUSTER CONNECTION CONFIG / REGISTRY FACTORY V1 PASSED"
        )
        print(
            "=" * 72
        )
        ...
        write_text(
            ...
            "\n".join(
                [
                    "Multi-Cluster Connection Config / Registry Factory v1 FAILED",
                    (
                        "GeneratedAt: "
