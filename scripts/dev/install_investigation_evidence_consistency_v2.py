...
VERSION = "investigation-evidence-consistency-v2"

AFTER_NAME = (
    "investigation_evidence_consistency_v2_after.txt"
)

ERROR_NAME = (
    "investigation_evidence_consistency_v2_error.txt"
)
...
def main() -> int:
    ...
    report = [
        "Investigation Evidence Consistency v2",
        ...
        "",
        "Guard changes:",
        "- v2 activates threshold consistency only when a complete trusted numeric working-set/limit pair exists",
        "- incomplete or non-numeric threshold evidence falls back to generic Epistemic Guard semantics",
    ...
    try:
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Evidence Consistency v2 is installed.",
                "",
                "Expected acceptance changes:",
                "- oom_without_explanatory_metrics can no longer succeed by citing pod-state only while ignoring a complete far-below-limit numeric pair",
                "- legacy pod-only/incomplete-numeric paths retain generic Guard behavior",
        ...
        print("=" * 72)
        print(
            "INVESTIGATION EVIDENCE CONSISTENCY V2 PASSED"
        )
        print("=" * 72)
        print("")
        print(
        ...
        write_text(
            ...
            "\n".join(
                [
                    "Investigation Evidence Consistency v2 FAILED",
                    f"GeneratedAt: {datetime.now().astimezone().isoformat()}",
                    "",
                    "Exception:",
