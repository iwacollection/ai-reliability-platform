...
VERSION = "investigation-causal-sufficiency-v2"
AFTER_NAME = "investigation_causal_sufficiency_v2_after.txt"
ERROR_NAME = "investigation_causal_sufficiency_v2_error.txt"
...
def main() -> int:
    ...
    report = [
        "Investigation Causal Sufficiency v2",
    ...
    try:
        ...
        print("=" * 72)
        print(
            "INVESTIGATION CAUSAL SUFFICIENCY V2 PASSED"
        )
        print("=" * 72)
        print("")
        print(
        ...
        write_text(
            ...
            "\n".join(
                [
                    "Investigation Causal Sufficiency v2 FAILED",
                    f"GeneratedAt: {datetime.now().astimezone().isoformat()}",
                    "",
                    "Exception:",
