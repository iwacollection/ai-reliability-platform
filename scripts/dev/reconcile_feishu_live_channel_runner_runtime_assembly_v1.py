...
VERSION = "feishu-live-channel-runner-runtime-assembly-v1-reconcile1"

AFTER_NAME = "feishu_live_channel_runner_runtime_assembly_v1_reconcile1_after.txt"
ERROR_NAME = "feishu_live_channel_runner_runtime_assembly_v1_reconcile1_error.txt"
...
def main() -> int:
    ...
    report = [
        "Feishu Live Channel Runner + Runtime Assembly v1 reconcile1",
        (
            "GeneratedAt: "
            + datetime.now()
            .astimezone()
    ...
    try:
        ...
        for path, source in targets.items():
            ...
            if path.exists():
                ...
                if (
                    ...
                    raise RuntimeError(
                        "Live Runner v1 existing target differs from the reviewed "
                        "installer payload; refusing overwrite: "
                        + relative
                        + " expected_sha256="
                        + expected_target_hash
                        + " actual_sha256="
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Feishu Live Channel Runner + Runtime Assembly v1 is reconciled and verified.",
                "",
        ...
        print("=" * 72)
        print(
            "FEISHU LIVE CHANNEL RUNNER + RUNTIME ASSEMBLY V1 RECONCILE1 PASSED"
        )
        print("=" * 72)
        print()
        print(
        ...
        report.extend(
            [
                ...
                "=" * 120,
                "",
                "Any newly created missing Live Runner v1 files were removed; pre-existing identical targets were preserved.",
            ...
            "\n".join(
                [
                    (
                        ...
                        "Runtime Assembly v1 reconcile1 FAILED"
                    ),
                    (
                        "GeneratedAt: "
                        + datetime.now()
        ...
        print("=" * 72)
        print(
            "FEISHU LIVE CHANNEL RUNNER + RUNTIME ASSEMBLY V1 RECONCILE1 FAILED"
        )
        print("=" * 72)
        print()
        print(
