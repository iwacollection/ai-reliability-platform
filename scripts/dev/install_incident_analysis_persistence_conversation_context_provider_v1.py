...
VERSION = (
    "incident-analysis-persistence-conversation-context-provider-v1"
)

AFTER_NAME = (
    "incident_analysis_persistence_conversation_context_provider_v1_after.txt"
)

ERROR_NAME = (
    "incident_analysis_persistence_conversation_context_provider_v1_error.txt"
)
...
def main() -> int:
    ...
    report = [
        "Incident Analysis Persistence + Runtime Conversation Context Provider v1",
        (
            "GeneratedAt: "
    ...
    try:
        ...
        persistence_paths = require_tests(
            root,
            [
                (
                    "services/agent_runtime/tests/"
                    "test_incident_store_persistence.py"
                ),
                (
                    "services/agent_runtime/tests/"
                    "test_approval_store_persistence.py"
                ),
                (
                    "services/agent_runtime/tests/"
                    "test_action_execution_store.py"
                ),
                (
                    "services/agent_runtime/tests/"
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Incident Analysis Persistence + Runtime Conversation Context Provider v1 is installed.",
                "",
        ...
        print("=" * 72)
        print(
            "INCIDENT ANALYSIS PERSISTENCE + CONVERSATION CONTEXT V1 PASSED"
        )
        print("=" * 72)
        print()
        print(
            ...
            "\n".join(
                [
                    (
                        ...
                        "Conversation Context Provider v1 FAILED"
                    ),
                    (
                        "GeneratedAt: "
                        + datetime.now().astimezone().isoformat()
        ...
        print("=" * 72)
        print(
            "INCIDENT ANALYSIS PERSISTENCE + CONVERSATION CONTEXT V1 FAILED"
        )
        print("=" * 72)
        print()
        print(
