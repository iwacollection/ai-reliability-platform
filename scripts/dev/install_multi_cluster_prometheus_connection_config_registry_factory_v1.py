...
def main() -> int:
    ...
    report = [
        "Multi-Cluster Prometheus Connection Config / Registry Factory v1",
    ...
    try:
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Multi-Cluster Prometheus Connection Config / Registry Factory v1 is installed.",
                "",
        ...
        print("=" * 72)
        print(
            "MULTI-CLUSTER PROMETHEUS CONNECTION CONFIG / REGISTRY FACTORY V1 PASSED"
        )
        print("=" * 72)
        print()
        print(
        ...
        write_text(
            ...
            "\n".join(
                [
                    "Multi-Cluster Prometheus Connection Config / Registry Factory v1 FAILED",
                    (
                        "GeneratedAt: "
