...
VERSION = "feishu-chatops-adapter-core-v1"

AFTER_NAME = "feishu_chatops_adapter_core_v1_after.txt"
ERROR_NAME = "feishu_chatops_adapter_core_v1_error.txt"
...
def main() -> int:
    ...
    report = [
        "Feishu ChatOps Adapter Core v1",
        (
            "GeneratedAt: "
    ...
    try:
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Feishu ChatOps Adapter Core v1 is installed.",
                "",
        ...
        print("=" * 72)
        print("FEISHU CHATOPS ADAPTER CORE V1 PASSED")
        print("=" * 72)
        print()
        ...
        error.write_text(
            "\n".join(
                [
                    "Feishu ChatOps Adapter Core v1 FAILED",
                    (
                        "GeneratedAt: "
                        + datetime.now().astimezone().isoformat()
                    ),
        ...
        print("=" * 72)
        print("FEISHU CHATOPS ADAPTER CORE V1 FAILED")
        print("=" * 72)
        print()
