...
VERSION = "investigation-intelligence-benchmark-v1"

AFTER_NAME = (
    "investigation_intelligence_benchmark_v1_after.txt"
)

ERROR_NAME = (
    "investigation_intelligence_benchmark_v1_install_error.txt"
)
...
def main() -> int:
    ...
    report = [
        "Investigation Intelligence Benchmark v1 Installer",
    ...
    try:
        ...
        print("=" * 72)
        print(
            "INVESTIGATION INTELLIGENCE BENCHMARK V1 INSTALLED"
        )
        print("=" * 72)
        print("")
        print(
        ...
        error_lines = [
            "Investigation Intelligence Benchmark v1 Installer FAILED",
            f"GeneratedAt: {datetime.now().astimezone().isoformat()}",
            "",
            "Exception:",
            f"{type(exc).__name__}: {exc}",
        ...
        print("=" * 72)
        print(
            "INVESTIGATION INTELLIGENCE BENCHMARK V1 INSTALL FAILED"
        )
        print("=" * 72)
        print("")
        print(
