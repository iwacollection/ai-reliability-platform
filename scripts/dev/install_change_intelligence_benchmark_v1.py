...
VERSION = "change-intelligence-benchmark-v1"

AFTER_NAME = (
    "change_intelligence_benchmark_v1_after.txt"
)

ERROR_NAME = (
    "change_intelligence_benchmark_v1_error.txt"
)
...
def main() -> int:
    ...
    report = [
        "Change Intelligence Benchmark v1",
    ...
    try:
        ...
        report.extend(
            [
                "PASSED",
                "",
                "Change Intelligence Benchmark v1 is installed.",
                "",
        ...
        print("=" * 72)
        print(
            "CHANGE INTELLIGENCE BENCHMARK V1 PASSED"
        )
        print("=" * 72)
        print("")
        print(
        ...
        write_text(
            ...
            "\n".join(
                [
                    "Change Intelligence Benchmark v1 FAILED",
                    f"GeneratedAt: {datetime.now().astimezone().isoformat()}",
                    "",
